...
image::diagrams/dsl-builder-class-diagram.svg[alt="Domain Builder Model Class diagram", max-width=1024, link="diagrams/dsl-builder-class-diagram.svg"]

== Domain Model Class diagram
image::diagrams/dsl-api-class-diagram.svg[alt="Domain Model Class diagram", max-width=1024, link="diagrams/dsl-api-class-diagram.svg"]
...
ifndef::env-github[]
== Domain Model Class diagram
plantuml::puml/dsl-api-class-diagram.puml[format=svg, alt="Domain Model Class diagram", max-width=1024, link="dsl-api-class-diagram.svg"]

== Domain Builder Model Class diagram
plantuml::puml/dsl-builder-class-diagram.puml[format=svg, alt="Domain Model Class diagram", max-width=1024, link="dsl-builder-class-diagram.svg"]
